...
if (!function_exists('pagination')) {
  function pagination($pages, $paged, $range = 2, $show_only = false) {
    ...
    if ($show_only && $pages === 1) {
      echo '<nav class="c-pager1" aria-label="Pagination"><span class="current" aria-current="page">1</span></nav>';
      return;
    }
    ...
    if (1 !== $pages) {
      echo '<nav class="c-pager1"  aria-label="Pagination">';
      echo '<ul class="c-pager1__list u-font-bold" role="list">';
